  ...
  return (
    <ResponsiveContainer>
      <div className="mx-10 xl:mx-0">
        ...
        <p className="mt-10 text-[.8rem] lg:text-2xl text-justify">
          ...
          tailored to the individual needs of each participant. My goal is not
          just to teach a language, but to make it come alive—through real-life
          methods, interactive activities, and clear structures that make
          learning both effective and enjoyable. Whether in one-on-one sessions
          or group classes, I focus on customized instruction that delivers
          exactly what’s needed—be it exam preparation, business communication,
          or professional development. Many of my clients appreciate my clear
          teaching style, the friendly yet professional learning environment,
          and my ability to explain even complex topics in a simple, practical,
          and relatable way.
        </p>
        <div>
